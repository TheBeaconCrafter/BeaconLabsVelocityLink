...
@NullMarked
public final class FriendsCommand implements BasicCommand {
    public static final String PERMISSION = "beaconlabs.velocitylink.friends";

    private final BeaconLabsVelocityLink plugin;

    public FriendsCommand(BeaconLabsVelocityLink plugin) {
        this.plugin = plugin;
    }
    ...
    public void execute(CommandSourceStack stack, String[] args) {
        ...
        plugin.openFriends(player, args);
    }
